...
class MinimaxYinshPlayer(YinshPlayer):
    ...
    def __heuristic(self, state: YinshState):
        grid = state.get_grid()
        longest = 0
    ...
    def minimax(self, state: YinshState, depth: int, alpha: int = -sys.maxsize, beta: int = sys.maxsize,
    ...
    def get_action(self, state: YinshState):
        return YinshAction(self.minimax(state, 5))
